...
class AList<T> implements ListInterface<T> {
    ...
    */public void reverse()
    {
    	...
    	// swap elements by taking one from start and one from end and start moving towards the middle
    ...
    */
    public void cycle()
    {
    	...
    	//Copy each element to it's (i-1)th index 
    	for(i=2;i<=numberOfEntries;i++)
    		list[i-1]=list[i];
        
    	//Copy the value of the first element stored in temp to the last position
